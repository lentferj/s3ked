...
SCALES: Dict[Tuple[str, str], Scale] = {
    ...
    ("program", "LFODEP"): Scale(
        ...
        note="CONDITIONAL ON AN UNRECORDED `L_PTCH` -- read this first.\n"
             "Keygroup offset 150, `L_PTCH`, 'amount of control of pitch by\n"
             "LFO1', GATES this route completely: measured 2026-08-24,\n"
             "LFODEP 99 with L_PTCH 0 produces NO vibrato at all (62.5 cents\n"
             "peak-to-peak against a 74 cent detector floor), while LFODEP 99\n"
             "with L_PTCH 50 gives several hundred. The sweep that produced\n"
             "the 19.4932 figure never set L_PTCH and neither §35 nor §44\n"
             "records what it was, so this constant is the law at some\n"
             "UNKNOWN non-zero L_PTCH rather than a full-scale reference.\n"
             "It cannot have been 0 or §35 would have measured silence.\n"
             "How the two compose is UNMEASURED -- a frame-wise pitch tracker\n"
             "cannot do it, see RESOLUTION_NOTES §159. Do not scale this by\n"
             "L_PTCH/50 or any other guessed factor.\n"
             "Everything below stands only for whatever L_PTCH the sweep ran\n"
             "at, and the SHAPE (linear, through the origin) is unaffected.\n"
