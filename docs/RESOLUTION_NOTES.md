...
91 sections. Each is referenced from code comments as `RESOLUTION_NOTES §N`;
the numbers never change, so a stale reference is a broken one rather than a
silently wrong one.

- [§1](#1--protocol-survey-what-this-family-has-and-what-it-does-not-resolved-2026-08-08) — Protocol survey: what this family has, and what it does not (resolved, 2026-08-08)
- [§2](#2--provenance-of-the-parameter-tables-and-what-that-costs-us-open-partly-mitigated) — Provenance of the parameter tables, and what that costs us (open, partly mitigated)
- [§3](#3--keygroup-offsets-161162-documented-twice-resolved-from-the-manual) — Keygroup offsets 161/162 documented twice (RESOLVED from the manual)
- [§4](#4--note-name-octave-offset-resolved-from-three-sources) — Note-name octave offset (RESOLVED from three sources)
- [§5](#5--the-miscellaneous-data-index-table-is-missing-from-the-source-open) — The miscellaneous data-index table is missing from the source (open)
- [§6](#6--the-sysex-send-gap-measured-resolved-on-hardware-2026-08-10) — The SysEx send gap, measured (RESOLVED on hardware, 2026-08-10)
...
- [§13](#13--name-fields-and-the-41-character-set-settled-both-ways-2026-08-10) — Name fields and the 41-character set, settled both ways (2026-08-10)
- [§14](#14--the-block-identifier-at-offset-0-and-the-trap-it-guards-2026-08-10) — The block identifier at offset 0, and the trap it guards (2026-08-10)
- [§15](#15--modulation-sources-0-means-no-source-and-reading-it-as-data-cost-a-correction-2026-08-10) — Modulation sources: 0 means "no source", and reading it as data cost a correction (2026-08-10)
- [§16](#16--the-first-filter-sweep-failed-and-how-2026-08-10) — The first filter sweep failed, and how (2026-08-10)
- [§17](#17--filfrq-does-not-audibly-move-the-filter-measured-2026-08-10) — `FILFRQ` does not audibly move the filter (measured 2026-08-10)
- [§18](#18--retraction-every-audio-measurement-before-this-was-of-the-wrong-program) — RETRACTION: every audio measurement before this was of the wrong program
...
- [§35](#35--lfodep-and-lfodel-and-a-floor-i-read-as-data-2026-08-11) — `LFODEP` and `LFODEL`, and a floor I read as data (2026-08-11)
- [§36](#36--vloud-and-a-shape-test-that-could-only-pick-the-least-wrong-2026-08-11) — `V_LOUD`, and a shape test that could only pick the least wrong (2026-08-11)
- [§37](#37--retraction-vloud-boosts-it-does-not-attenuate--and-the-knee-was-mine-2026-08-11) — RETRACTION. `V_LOUD` boosts, it does not attenuate — and the knee was mine (2026-08-11)
- [§38](#38--the-headroom-audit-what-the-ceiling-did-and-did-not-damage-2026-08-11) — The headroom audit: what the ceiling did and did not damage (2026-08-11)
- [§39](#39--retracted-by-52-the-pan-lfo-does-nothing-on-this-machine-and-panpos-cross-validates-2026-08-11) — RETRACTED by §52. The pan LFO does nothing on this machine, and `PANPOS` cross-validates (2026-08-11)
- [§40](#40--velocity-routing-at-the-zone-level-and-the-whole-attack-family-is-unsettled-2026-08-11) — Velocity routing at the zone level, and the whole attack family is unsettled (2026-08-11)
- [§41](#41--the-attacks-were-never-underdetermined-40s-diagnosis-was-wrong-2026-08-11) — The attacks were never underdetermined. §40's diagnosis was wrong (2026-08-11)
- [§42](#42--attak2-settled-and-the-33--was-a-selection-bug-all-along-2026-08-11) — `ATTAK2` settled, and the 33 % was a selection bug all along (2026-08-11)
- [§43](#43--kfreq-is-exactly-what-the-document-says-once-the-reference-is-known-2026-08-11) — `K_FREQ` is exactly what the document says, once the reference is known (2026-08-11)
- [§44](#44--all-four-lfo1-depth-sources-are-one-law-and-the-pivot-rule-is-refuted-for-controllers-2026-08-12) — All four LFO1 depth sources are one law, and the pivot rule is refuted for controllers (2026-08-12)
- [§45](#45--retracted-by-51-the-whole-per-zone-velocity-block-is-inert-2026-08-12) — RETRACTED by §51. The whole per-zone velocity block is inert (2026-08-12)
- [§46](#46--lfo1wave-confirmed-by-shape-and-a-fourth-waveform-2026-08-12) — `LFO1WAVE` confirmed by shape, and a fourth waveform (2026-08-12)
- [§47](#47--five-of-six-envelope-scaling-fields-are-inert-kdar1-is-not-2026-08-12) — Five of six envelope scaling fields are inert; `K_DAR1` is not (2026-08-12)
- [§48](#48--kdar1-measured-and-envelope-3-is-alive-after-all-2026-08-12) — `K_DAR1` measured, and envelope 3 is alive after all (2026-08-12)
...
- [§56](#56--the-tuning-fields-are-256x-wider-than-this-table-said-2026-08-12) — The tuning fields are 256x wider than this table said (2026-08-12)
- [§57](#57--a-corner-tracker-that-is-not-a-centroid-and-envelope-3-measured-with-it-2026-08-12) — A corner tracker that is not a centroid, and envelope 3 measured with it (2026-08-12)
- [§58](#58--envelope-2-re-measured-and-attak2s-depth-dependence-was-mine-2026-08-12) — Envelope 2 re-measured, and `ATTAK2`'s depth-dependence was mine (2026-08-12)
- [§59](#59--relse2-measured-and-the-family-turns-out-to-be-one-law-2026-08-12) — `RELSE2` measured, and the family turns out to be one law (2026-08-12)
- [§60](#60--the-structure-predicted-the-two-fields-it-had-never-seen-2026-08-12) — The structure predicted the two fields it had never seen (2026-08-12)
- [§61](#61--kdar2-measured-predicted-from-kdar1-2026-08-12) — `K_DAR2` measured, predicted from `K_DAR1` (2026-08-12)
- [§62](#62--key-scaling-reads-the-note-not-the-pitch--and-the-pivot-is-measured-2026-08-12) — Key scaling reads the note, not the pitch — and the pivot is measured (2026-08-12)
- [§63](#63--envelope-3s-scaling-set-all-three-work-and-two-nearly-did-not-2026-08-12) — Envelope 3's scaling set: all three work, and two nearly did not (2026-08-12)
- [§64](#64--vrel3-and-orel3-the-rig-could-not-have-measured-one-of-them-2026-08-12) — `V_REL3` and `O_REL3`: the rig could not have measured one of them (2026-08-12)
- [§65](#65--only-slot-1-modulates-the-filter-and-the--sources-are-not-inverted-2026-08-12) — Only slot 1 modulates the filter, and the "!" sources are not inverted (2026-08-12)
- [§66](#66--temper-was-twelve-bytes-modelled-as-one-number-2026-08-12) — `TEMPER` was twelve bytes modelled as one number (2026-08-12)
- [§67](#67--envelope-2-is-four-stages-too-and-attak2-is-a-rate-2026-08-12) — Envelope 2 is four stages too, and `ATTAK2` is a rate (2026-08-12)
- [§68](#68--the-disk-is-readable-over-midi-it-is-not-loadable-2026-08-12) — The disk is readable over MIDI. It is not loadable (2026-08-12)
- [§69](#69--the-directory-record-decoded-what-a-volume-costs-in-ram-2026-08-12) — The directory record decoded: what a volume costs in RAM (2026-08-12)
- [§70](#70--the-load-source-mapped-the-partition-is-remotely-settable-2026-08-12) — The load source, mapped: the partition is remotely settable (2026-08-12)
- [§71](#71--writing-the-load-type-started-a-load-and-wedged-the-machine-2026-08-12) — Writing the load type started a load, and wedged the machine (2026-08-12)
- [§72](#72--five-of-six-the-load-and-the-menu-are-remotely-controllable-2026-08-12) — Five of six: the load and the menu are remotely controllable (2026-08-12)
- [§73](#73--all-progs--samples-adds-and-the-fit-check-is-right-for-it-2026-08-12) — ALL PROGS + SAMPLES *adds*, and the fit check is right for it (2026-08-12)
- [§74](#74--the-load-trigger-has-one-value-and-clr-is-not-remote-2026-08-12) — The load trigger has one value, and CLR is not remote (2026-08-12)
- [§75](#75--clr-is-a-panel-chain-the-effect-is-reachable-the-button-is-not-2026-08-13) — CLR is a panel chain; the effect is reachable, the button is not (2026-08-13)
- [§76](#76--the-drive-id-records-a-choice-a-second-write-makes-the-machine-act-2026-08-13) — The drive ID records a choice; a second write makes the machine act (2026-08-13)
- [§77](#77--what-a-power-cycle-settles-five-defaults-and-one-reserve-2026-08-13) — What a power cycle settles: five defaults and one reserve (2026-08-13)
- [§78](#78--sweeping-pages-with-absent-media-wedges-the-machine-2026-08-13) — Sweeping pages with absent media wedges the machine (2026-08-13)
- [§79](#79--eleven-modes-confirmed-and-11-is-a-crash-not-a-refusal-2026-08-13) — Eleven modes, confirmed; and 11 is a crash, not a refusal (2026-08-13)
- [§80](#80--the-cross-reference-and-a-fixture-that-was-a-false-claim-2026-08-13) — The cross-reference, and a fixture that was a false claim (2026-08-13)
- [§81](#81--overlapping-keygroups-layer-neither-shadows-the-other-2026-08-13) — Overlapping keygroups layer; neither shadows the other (2026-08-13)
- [§82](#82--refusing-the-reads-the-device-answers-with-somebody-elses-data-2026-08-13) — Refusing the reads the device answers with somebody else's data (2026-08-13)
- [§83](#83--the-undescribed-sample-header-tail-has-visible-structure-2026-08-13) — The undescribed sample-header tail has visible structure (2026-08-13)
- [§84](#84--all-eleven-main-menu-pages-named-at-the-panel-2026-08-13) — All eleven main-menu pages, named at the panel (2026-08-13)
- [§85](#85--value-11-crashes-the-firmware-and-the-lcd-is-what-proved-it-2026-08-13) — Value 11 crashes the firmware, and the LCD is what proved it (2026-08-13)
- [§86](#86--the-mode-register-walks-past-the-panels-own-hardware-gate-2026-08-13) — The mode register walks past the panel's own hardware gate (2026-08-13)
- [§87](#87--envelope-3-does-not-need-the-ib304f-and-the-note-saying-so-cited-an-unrelated-finding-2026-08-13) — Envelope 3 does not need the IB304F, and the note saying so cited an unrelated finding (2026-08-13)
